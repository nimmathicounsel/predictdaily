...
import '../utils/lang_filenames_extractor.dart';
...
final SettingsSection languageSettings = SettingsSection(
  title: 'Language',
  bannerColor: AppColors.softBlue,
  children: [
      ...
      builder: (BuildContext context, StateSetter setElementState) {
        return FutureBuilder<List<dynamic>>(
          ...
          future: Future.wait([
            ...
            LangfilenamesExtractor.getLanguageFiles()
          ]),
          builder: (context, snapshot) {
            ...
            final String language = snapshot.data![0] as String;
            final List<String> languages =  List<String>.from(snapshot.data![1]);
            ...
            return Column(
                ...
                DropdownButton<String>(
                    ...
                    onChanged: (newValue) async {
                      await SettingsService.saveLanguage(newValue ?? AppConstants.defaultLanguage);
                      await AppLocalization.load(newValue ?? AppConstants.defaultLanguage);
                      setElementState(() {});
                    },
          )
                ]
